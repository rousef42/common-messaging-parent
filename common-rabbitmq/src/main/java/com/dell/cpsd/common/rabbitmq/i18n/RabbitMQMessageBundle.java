...
public class RabbitMQMessageBundle extends ListResourceBundle
{
     ...
     */
    private static final Object[][] CONTENTS = {{"VAMQP1001E", "VAMQP1001E Failed to initialize the AMQP connection factory. Reason [{0}]"},
            ...
            {"VAMQP1005E", "VAMQP1005E No exchange was found with the name [{0}]"},
            {"VAMQP1006E", "VAMQP1006E [{0}] Unhandled message received: [{1}]"},
            {"VAMQP1007E", "VAMQP1007E [{0}] AMQP acknowledgment error: [{1}]"},
            {"VAMQP1008E", "VAMQP1008E AMQP error (attempt {0}): [{1}]"}, {"VAMQP1009E", "VAMQP1009E [{0}] AMQP error: [{1}]"},
