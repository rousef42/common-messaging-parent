...
@MessageExchange(exchange = "exchange.test.{providerId}.something", routingKey = "routing.base")
@MessageRequest
public class FlavouredTestRequestMessage
{
    ...
    public FlavouredTestRequestMessage(String correlationId, String replyTo, String asdf)
    {
