...
/**
 * Unit tests for EventMessageValidator.
 *
 * <p>
 * Copyright &copy; 2017 Dell Inc. or its subsidiaries. All Rights Reserved. Dell EMC Confidential/Proprietary Information
 * </p>
...
{
    EventMessageValidator<TestReplyMessage> validator;

    @Before
    public void setUp() throws Exception
    {
        validator = new EventMessageValidator<TestReplyMessage>();
    }
    ...
    /**
     * ReplyTo is not required for a event Message
     * 
     * @throws Exception
     */
    @Test
